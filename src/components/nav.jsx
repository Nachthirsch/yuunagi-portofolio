...
import { Menu, X, Camera, Briefcase, PenTool, Maximize2, Minimize2 } from "lucide-react";
  ...
  const getMenuItems = (isV2) => {
    ...
    return [
      ...
      { 
        ...
        icon: <Camera size={18} />, 
        label: "Photography",
        description: "Explore my visual stories"
      },
    ];
  };
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 p-4">
      ...
      <div className="hidden md:flex absolute left-4 top-4">
        <div className="bg-black bg-opacity-10 backdrop-blur-sm rounded-full p-1 
      ...
      <div className="hidden md:block max-w-[320px] mx-auto">
        {menuItems.length > 0 && (
          <div className="bg-black bg-opacity-10 backdrop-blur-sm rounded-full px-4 py-2.5 
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-black bg-opacity-10 backdrop-blur-xl 
