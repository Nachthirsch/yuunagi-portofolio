...
const BlogList = () => {
  ...
  if (loading) return <div className="text-center text-neutral-400 py-8">Loading posts...</div>;
  if (error) return <div className="text-center text-red-400 py-8">Error: {error}</div>;
  if (!allPosts?.length) return <div className="text-center text-neutral-400 py-8">No posts found</div>;
