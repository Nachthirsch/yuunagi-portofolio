...
const SectionHeader = ({ subtitle, title, highlightedWord }) => {
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-32 relative">
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className={`h-[2px] flex-grow bg-gradient-to-r ${cert.color} opacity-30`} />
          <span className="text-xs font-medium text-neutral-500 whitespace-nowrap">{cert.category}</span>
          <div className={`h-[2px] flex-grow bg-gradient-to-l ${cert.color} opacity-30`} />
        </div>
