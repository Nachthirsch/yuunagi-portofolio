...
import { Code2, Github, MonitorSmartphone, ExternalLink } from "lucide-react";
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="px-3 py-1 bg-orange-50/50 text-orange-500 
        ...
        <div className="mb-auto">
          ...
          <p className="text-neutral-600 text-[15px] leading-relaxed line-clamp-3">
            {project.description}
          </p>
        </div>
